...
<body class="bg-white font-[Poppins]">
  ...
  <div class="sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] duration-1000
    ...
    <div class="text-gray-100 text-xl">
      <div class="p-2.5 mt-1 flex items-center rounded-md ">
        ...
        <h1 class="text-[15px] ml-3 text-xl text-gray-200 font-bold">UserHome</h1>
      ...
      <div>
        ...
        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-gray-600">
          ...
          <span class="text-[15px] ml-4 text-gray-200"><a href="view_userprofile.php">View Profile</a></span>
        </div>
        ...
        <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-gray-600">
          ...
          <span class="text-[15px] ml-4 text-gray-200"><a href="index.php">Logout</a></span>
        </div>
  ...
  <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
    <h1 class="text-4xl text-cyan-900 font-serif font-semibold">WELCOME  USER ....</h1>
  </div>
  <div id="manageProfileModal" class="modal">
        <div class="modal-content">
            <span class="close-modal" onclick="closeManageProfileModal()">&times;</span>
            <!-- Content of the manage profile modal will be loaded here using JavaScript -->
        </div>
    </div>
  <script>
    function dropDown() {
